        ...
        <Navbar/>
            <div className="recipes-home-body inner-page">
                                    ...
                                    <div className="single-recipe-detail">
                                        <div className="wrapper-recipe-heading">
                                            <div className="heading">
                                                ...
                                                <div className="rating-box">
                                                    <span className="rating-icons">
                                                        <svg className="icon-container" width="25" height="19"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 19">
                                                            <g>
                                                    ...
                                                    <span className="rating-icons"><svg className="icon-container" width="25"
                                                        height="19" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 19">
                                            ...
                                            <div className="recipe-media">
                                                <a className="button-dark watch-video swipebox"
                                                    target="_blank" href="https://www.youtube.com/watch?v=xWZeQBLV6q4">Watch Video</a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="slider-recipe-detail"> 
                                            <div className="flex-viewport">
                                                <ul>
                                                    <li>
                                                        <Link rel="recipe-slider-1" to="biryani.jfif"
                                                            className="swipebox">
                                                            <img src={"../img/noodles.jpg"}alt="Recipe Single Image" style={{ width: "765px", float: "left", display: "block" }} />
                                                        </Link>
                                                    </li>
                                                </ul>
                                            </div>
                                            <ul className="recipe-specs">
                                                <li><span className="count">5</span><span className="text">Yield</span></li>
                                                <li><span className="count">7</span><span className="text">Servings</span></li>
                                                <li><span className="count">10<span>m</span></span><span className="text">Prep
                                                    Time</span></li>
                                                <li><span className="count">25<span>m</span></span><span className="text">Cook
                                                    Time</span></li>
                                                <li><span className="count">30<span>m</span></span><span className="text">Ready
                                                    In</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="recipe-detail-body">
                                        <Link to="#" className="print-button"><i className="fa fa-print"></i>Print Recipe</Link>

                                        <ul className="pre-tags">
                                            <li><span>Cuisine : </span>Chinese</li>
                                            <li><span>Course : </span>Side Dish</li>
                                            <li><span>Skill Level : </span>Easy</li>
                                        </ul>
                                        <div className="separator-post"></div>
                                        <p>
                                            This veg noodles recipe, made with all of your favorite fresh vegetables, is perfect
                                            for a quick a weeknight meal! Ready in just 30 minutes, this Chinese-style stir
                                            fried veggie noodles is kid-friendly and fully customizable. This easy stir fried
                                            veggie noodles recipe has just the right level of spice. Not too much heat, not very
                                            pungent, but still filled with so much flavor, this kid-friendly noodles recipe is
                                        ...
                                        <div className="recipe-steps">
                                            ...
                                            <ul className="steps-list">
                                                <li>
                                                    <div className="step-single">
                                                        <div className="step-image">
                                                            <Link to="noodles.jpg" rel="recipe-slider-1" className="swipebox"><img src={"../img/vege.jfif"} alt="image" style={{ height: "204px" }} /></Link>
                                                        </div>
                                                        <div className="step-detail">
                                                            <h3>Step 1.</h3>
                                                            <p>
                                                                First rinse and shred or chop all the veggies, then set aside.
                                                                You will need 1 cup shredded cabbage, ½ shredded carrots, 8 to
                                                                10 french beans (thinly sliced or finely chopped), ⅓ sliced
                                                                capsicum and ⅓ cup chopped spring onion whites.<br />Increase the
                                                                quantity of veggies according to your preferences. Add some
                                                                cremini or button mushrooms if you like.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li>
                                                    <div className="step-single">
                                                        <div className="step-image">
                                                            <Link to="noodles.jpg" rel="recipe-slider-1" className="swipebox"><img src={"../img/boil.jfif"} alt="image" style={{ height: "180px",  width:"100%" }} /></Link>
                                                        </div>
                                                        <div className="step-detail">
                                                            <h3>Step 2.</h3>
                                                            <p>
                                                                Next heat 5 to 6 cups of water in a pan. Then when the water
                                                                comes to a boil, add ½ teaspoon salt. Next add ½ teaspoon oil
                                                                and mix well. Add any neutral oil. Then add the noodles (about
                                                                200 grams). I have used whole wheat noodles. The recipe is
                                                                customizable with any noodles – instant, ramen, soba, chow mein,
                                                                udon, rice.
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <li>
                                                    <div className="step-single">
                                                        <div className="step-image">
                                                            <Link to="noodles.jpg" rel="recipe-slider-1" className="swipebox"><img src={"../img/drain.jfif"} alt="image" style={{ height: "179px" , width:"100%" }} /></Link>
                                                        </div>
                                                        <div className="step-detail">
                                                            <h3>Step 3.</h3>
                                                            <p>
                                                                Be sure to check the doneness throughout the noodles recipe by
                                                                pressing a few noodles or tasting them. They should be softened,
                                                                but still have a slight bite to them. Next rinse the noodles
                                                                with fresh water. After that, set aside. You can even toss the
                                                                noodles recipe with 2 to 3 teaspoons oil if desired.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li>
                                                    <div className="step-single">
                                                        <div className="step-image">
                                                            <Link to="#" rel="recipe-slider-1" className="swipebox"><img src={"../img/fry.jfif"} alt="image" style={{ height: "202px", width:"100%" }} /></Link>
                                                        </div>
                                                        <div className="step-detail">
                                                            <h3>Step 4.</h3>
                                                            <p>
                                                                Now heat 2 to 3 tablespoons of toasted sesame oil in a wok or
                                                                pan. Keep the heat to low or medium-low. Add 1 teaspoon finely
                                                                chopped garlic and 1 teaspoon finely chopped ginger. Swap
                                                                toasted sesame oil with any neutral oil or olive oil. Next
                                                                stir-fry or sauté for some seconds. Then increase the flame to
                                                                high and add ⅓ cup chopped spring onions (scallions).
                                                            </p>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li>
                                                    <div className="step-single">
                                                        <div className="step-image">
                                                            <Link to="noodles.jpg" rel="recipe-slider-1" className="swipebox"><img
                                                                src={"../img/noodles.jpg"} alt="image" style={{ height: "174px" }} /></Link>
                                                        </div>
                                                        <div className="step-detail">
                                                            <h3>Step 5.</h3>
                                                            <p>
                                                                Keep on tossing and stirring till the veggies are mixed well for
                                                                minute or two. Switch off the heat. Check the taste and add more
                                                                salt, black pepper or soy sauce if required to the veggie
                                                                noodles. Lastly add 1 to 2 tablespoons chopped spring onion
                                                                greens. Mix well. Finally, serve this veg noodles recipe
                                                                steaming hot as it is or with some black bean sauce or tomato
                                                                sauce.
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="tips-variations">
                                            ...
                                            <ul>
                                                <li>
                                                    <p>
                                                        Use any good quality noodles. You can use whole wheat noodles or plain
                                                        flour noodles. This veg noodle recipe can also be made with hakka
                                                        noodles, chowmein noodles, udon noodles or instant noodles.
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                        Another very important point when making any noodle dish is that they
                                                        have to be cooked perfectly and should be non-sticky. When the noodles
                                                        are al dente or just about cooked, strain them in a colander. Then rinse
                                                        them with fresh water. Drain off the extra water and toss them with 2 to
                                                        3 teaspoons of oil.
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                        If possible use toasted sesame oil. It gives a good smoky flavor to the
                                                        veggie noodles.
                                                    </p>
                                                </li>
                                            </ul>
                                                ...
                                                <div className="col-sm-7">
                                                    <div className="details-tags">
                                                        <ul>
                                                            ...
                                                            <li><Link to="#">chilly</Link></li>
                                                            <li><Link to="#">soya sauce</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="category-list">
                                            <ul>
                                                <li>
                                                    ...
                                                    <div className="list-icons"><svg version="1.1" className="icon-container"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        width="42px" height="42px" viewBox="0 0 42 42"
                                                        enable-background="new 0 0 42 42" xmlSpace="preserve">
                                                        <path className="icon-svg" d="M38.001,22.42v11.577c0,1.653-1.349,3-3.001,3h-8H7c-1.654,0-2.999-1.347-2.999-3V22.42C2.036,20.542,1,18.331,1,16.001
                ...
                c0-0.828,0.672-1.499,1.5-1.499S13,18.672,13,19.5C13,20.329,12.329,21.001,11.5,21.001L11.5,21.001z">
                                                ...
                                                <li>
                                                    ...
                                                    <div className="list-icons"><svg version="1.1" className="icon-container"
                                                        ...
                                                        enable-background="new 0 0 42 48" xmlSpace="preserve">
                                                        <path className="icon-svg" d="M34,22.997c0-2.757-2.244-5-5.001-5c-1.641,0-3.088,0.805-3.999,2.031c-0.912-1.226-2.358-2.031-4-2.031
                    ...
                    c3.524,2.025,10.662,3.07,17.741,3.07s14.217-1.045,17.74-3.07C37.334,33.452,29.926,39.988,21,39.988z"></path>
                                                ...
                                                <li>
                                                    ...
                                                    <div className="list-icons"><svg version="1.1" className="icon-container"
                                                        ...
                                                        width="42px" height="48px" viewBox="0 0 42 48"
                                                        enable-background="new 0 0 42 48" xmlSpace="preserve">
                                                        <path className="icon-svg" d="M41.861,32.705c-0.311,0.756-1.041,1.245-1.86,1.245h-5.646c-0.563,0-1.021,0.452-1.021,1.008v2.512
                ...
                c1.105,0,2.001,0.89,2.001,1.987C18.009,17.1,17.112,17.99,16.007,17.99L16.007,17.99z"></path>
                                                ...
                                                <li>
                                                    ...
                                                    <div className="list-icons"><svg version="1.1" className="icon-container"
                                                        ...
                                                        width="42px" height="48px" viewBox="0 0 42 48"
                                                        enable-background="new 0 0 42 48" xmlSpace="preserve">
                                                        <path className="icon-svg" d="M36.793,25.391C36.603,25.146,36.311,25,36,25H6c-0.311,0-0.603,0.146-0.793,0.391c-0.19,0.246-0.253,0.567-0.173,0.867
                ...
                c-1.357,0-2.55-0.915-2.899-2.227L7.301,27h27.398L31.826,37.773z"></path>
                                                        <path className="icon-svg" d="M7,23c0.554,0,1-0.448,1-1c0-3.458,2.987-6.273,6.661-6.273c0.207,0,0.413,0.012,0.617,0.031
                ...
                c-1.164,0.465-2.219,1.168-3.086,2.088c-0.091-0.004-0.184-0.006-0.276-0.006C9.885,13.728,6,17.438,6,22C6,22.552,6.448,23,7,23z
                 M21,7c1.102,0,2,0.896,2,2c0,1.103-0.898,2-2,2c-1.102,0-2-0.896-2-2C19,7.896,19.898,7,21,7z"></path>
                                                        <path className="icon-svg" d="M23.049,18.313c-0.29,0.468-0.145,1.085,0.323,1.377c0.47,0.291,1.087,0.146,1.377-0.323C25.669,17.885,27.258,17,29.001,17
                ...
                C26.561,14.999,24.337,16.239,23.049,18.313z"></path>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div className="detail">
                                                    <Link to="#">SPECIAL MIX VEG</Link><br />
                                            ...
                                            <li>
                                                ...
                                                <div className="detail">
                                                    <Link to="#">CHILLY NOODLES</Link><br />
                                    ...
                                    <div className="widget widget-measurements">
                                        ...
                                        <Link className="default-btn small-button theme-color" to="#">Read More</Link>
                                    </div>
